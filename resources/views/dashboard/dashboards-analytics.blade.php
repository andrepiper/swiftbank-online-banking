                ...
                <div class="col-lg-6 col-md-12 col-6 mb-6">
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between mb-4">
                                ...
                                <div class="dropdown">
                                    <button class="btn p-0" type="button" id="cardOpt3" data-bs-toggle="dropdown"
                                        ...
                                        <i class="fas fa-dots-vertical-rounded text-muted"></i>
                                    </button>
                            ...
                            <small class="text-success fw-medium"><i class='fas fa-up-arrow-alt'></i> +72.80%</small>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-6 mb-6">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <small class="text-success fw-medium"><i class='fas fa-up-arrow-alt'></i> +28.42%</small>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-header d-flex align-items-center justify-content-between">
                            ...
                            <div class="dropdown">
                                <button class="btn p-0" type="button" id="totalRevenue" data-bs-toggle="dropdown"
                                        aria-haspopup="true" aria-expanded="false">
                                    <i class="fas fa-dots-vertical-rounded bx-lg text-muted"></i>
                                </button>
                                ...
                                <div class="d-flex">
                                    <div class="avatar me-2">
                                        <span class="avatar-initial rounded-2 bg-label-primary"><i
                                                    class="fas fa-dollar bx-lg text-primary"></i></span>
                                    </div>
                                ...
                                <div class="d-flex">
                                    <div class="avatar me-2">
                                        <span class="avatar-initial rounded-2 bg-label-info"><i
                                                    class="fas fa-wallet bx-lg text-info"></i></span>
                                    </div>
                                    <div class="d-flex flex-column">
                                        <small>
                                            <script>
                ...
                <div class="col-6 mb-6">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <small class="text-danger fw-medium"><i class='fas fa-down-arrow-alt'></i> -14.82%</small>
                        </div>
                    </div>
                </div>
                <div class="col-6 mb-6">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <small class="text-success fw-medium"><i class='fas fa-up-arrow-alt'></i> +28.14%</small>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                                    ...
                                    <div class="mt-sm-auto">
                                        <span class="text-success text-nowrap fw-medium"><i
                                                    class='fas fa-up-arrow-alt'></i> 68.2%</span>
            ...
            <div class="card h-100">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="dropdown">
                        <button class="btn text-muted p-0" type="button" id="orederStatistics" data-bs-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                            <i class="fas fa-dots-vertical-rounded bx-lg"></i>
                        </button>
                ...
                <div class="card-body">
                    ...
                    <ul class="p-0 m-0">
                        ...
                        <li class="d-flex align-items-center mb-5">
                            <div class="avatar flex-shrink-0 me-3">
                                <span class="avatar-initial rounded bg-label-info"><i class='fas fa-home-alt'></i></span>
                            </div>
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
                                ...
                                <div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <small class="text-success fw-medium">
                                            <i class='fas fa-chevron-up bx-lg'></i>
                                            42.9%
                                        </small>
                                    </div>
                                </div>
